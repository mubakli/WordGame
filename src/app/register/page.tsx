      ...
      <div className="w-full max-w-md bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl p-10 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-800">
        <div className="flex justify-center mb-6">
          <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-full">
            <UserPlus size={32} className="text-gray-800 dark:text-gray-200" />
          </div>
        </div>
        
        <h2 className="text-3xl font-extrabold text-center text-gray-900 dark:text-gray-100 mb-2">Create an Account</h2>
        <p className="text-center text-gray-500 dark:text-gray-400 mb-8">Start building your vocabulary decks today.</p>
